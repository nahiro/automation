...
parser.add_argument('-u','--ignore_uniformity',default=False,action='store_true',help='Ignore uniformity within a pixel (%(default)s)')
...
if args.rmax is not None:
    ...
    dst_data[dst_nsum > args.rmax] = dst_nodata
dst_dtype = gdal.GDT_Int32

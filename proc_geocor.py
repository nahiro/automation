...
proc_geocor.param_types['trg_binning'] = 'double'
proc_geocor.param_types['trg_range'] = 'double_list'
proc_geocor.param_types['init_shifts'] = 'double_list'
proc_geocor.param_types['part_sizes'] = 'double_list'
proc_geocor.param_types['gcp_intervals'] = 'double_list'
proc_geocor.param_types['max_shifts'] = 'double_list'
proc_geocor.param_types['margins'] = 'double_list'
...
proc_geocor.input_types['init_shifts'] = 'double_list'
proc_geocor.input_types['part_sizes'] = 'double_list'
proc_geocor.input_types['gcp_intervals'] = 'double_list'
proc_geocor.input_types['max_shifts'] = 'double_list'
proc_geocor.input_types['margins'] = 'double_list'

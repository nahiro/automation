...
proc_orthomosaic.params['pixel_size'] = 'Pixel Size'
...
proc_orthomosaic.param_types['qmin'] = 'double'
...
proc_orthomosaic.param_types['pixel_size'] = 'double'
proc_orthomosaic.param_types['scale_factor'] = 'double'
...
proc_orthomosaic.defaults['pixel_size'] = np.nan

...
proc_identify.params['point_nmin'] = 'Min Point# in a Plot'
...
proc_identify.params['neighbor_size'] = 'Neighborhood Size (pixel)'
...
proc_identify.param_types['data_range'] = 'double_list'
...
proc_identify.defaults['point_area'] = [0.0157,0.0962,0.0452]
proc_identify.defaults['rr_param'] = ['Lrg','S/N']
proc_identify.defaults['rthr'] = [1.0,0.01]
proc_identify.defaults['sthr'] = 2.0
...
proc_identify.list_sizes['rthr'] = 2
...
proc_identify.list_labels['rthr'] = ['Max :',' Step :']
...
proc_identify.input_types['data_range'] = 'double_list'
